...
(function (window, document, $) {
  ...
  select.each(function () {
    var $this = $(this);
    $this.wrap('<div class="position-relative is-invalid"></div>');
    $this.select2({
  ...
  maxLength.wrap('<div class="position-relative is-invalid"></div>').select2({
    dropdownAutoWidth: true,
    width: '100%',
  ...
  selectArray.wrap('<div class="position-relative is-invalid"></div>').select2({
    dropdownAutoWidth: true,
  ...
  // Loading remote data
  selectAjax.wrap('<div class="position-relative is-invalid"></div>').select2({
    dropdownAutoWidth: true,
