        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="row">
                    <div class="col-md-3">
                    <label for="old_password" class="float-right">Old Password <span class="text-danger asteric-sign">&#42;</span></label>
                    </div>
                    <div class="col-md-6">
                ...
                <br>
                    ...
                    <div class="row">
                    <div class="col-md-3">
                    <label for="exampleInputPassword1" class="float-right">Password <span class="text-danger asteric-sign">&#42;</span></label>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="row">
                    <div class="col-md-3">
                    <label for="exampleInputPassword2" class="float-right">Confirm Password <span class="text-danger asteric-sign">&#42;</span></label>
                  </div>
                    <div class="col-md-6">
