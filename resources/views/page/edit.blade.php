                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form method="POST" action="{{ route('page.update', $model->id) }}">
                                    @csrf
                                    @method('put')
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="title">Title <span class="text-danger asteric-sign">&#42;</span></label>
                                                      <input id="title" type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ (old('title')) ? (old('title')) : ($model->title) }}" placeholder="Full Name">
                                                        @if ($errors->has('title'))
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    @foreach($pageTypes as $key=>$value)
                                                       <option value="{{$key}}"{{$model->page_type == $key?"selected":""}}>{{$value}}</option>
                                                    @endforeach
                                                   </select>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea id="description" name="description" rows="10" class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Page Content">{{$model->description}}</textarea>
